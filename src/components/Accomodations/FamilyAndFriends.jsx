...
function FamilyAndFriends() {
  ...
  return (
    <>
      <div className="room-details">
        <div className="room-details-hero">
          <div className="room-details-hero-top">
            ...
            <h1>Family Suite / Triple / Quad Room</h1>
            <div className="room-details-hero-gallery">
              ...
              >
                <img src={BathroomsImg1} alt="Family and Friends Bathrooms" />
              </div>
              <div
                className="room-details-hero-gallery-img"
              ...
              >
                ...
                <Link
                  to="/accomodations/family-and-friends/gallery"
      ...
      <Reach />
      <OtherRooms otherRoom="family-and-friends" />
