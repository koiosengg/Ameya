  ...
  return (
    <div className="room-details">
      <div className="room-details-hero">
        ...
        <h1>Luxury, Cottage, 1 King bed, Sofa bed, Garden view, Balcony</h1>
        <div className="room-details-hero-gallery">
          <a className="show-more-photos-btn">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
        ...
        <div className="room-details-hero-about">
          ...
          <section>
            <p className="room-details-hero-about-text">
              Lorem ipsum dolor sit amet consectetur. Ultricies sed ullamcorper
              dictum in consequat viverra diam. Sed duis faucibus consectetur
              enim nunc amet. Mattis cursus ultrices sit eu lacus velit. Nulla
              eros felis faucibus dis fringilla fringilla purus tristique
              imperdiet.
            </p>
