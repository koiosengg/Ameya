...
import BedroomsImg3 from "../../assets/Accomodations/Smaller Groups/Bedrooms/Bedrooms Img 3.jpg";
...
import BathroomsImg2 from "../../assets/Accomodations/Smaller Groups/Bathrooms/Bathroom Img 2.jpg";
  ...
  return (
    <div className="room-details-gallery">
      ...
      <div className="gallery-space">
        <Spaceset title="Living Room" images={[LivingRoomImg1]} />
        <Spaceset
          title="Bedrooms"
          images={[BedroomsImg1, BedroomsImg2, BedroomsImg3]}
        />{" "}
        <Spaceset title="Balcony" images={[BalconyImg1]} />
...
export default SmallerGroupsGallery;
