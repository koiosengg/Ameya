...
import LivingRoomImg1 from "../../assets/Accomodations/Larger Groups/Living Room/Living Room Img 1.jpg";
import LivingRoomImg2 from "../../assets/Accomodations/Larger Groups/Living Room/Living Room Img 2.jpg";
import BathroomsImg1 from "../../assets/Accomodations/Larger Groups/Bathrooms/Bathroom Img 1.jpg";
import BedroomsImg1 from "../../assets/Accomodations/Larger Groups/Bedrooms/Bedrooms Img 1.jpg";
import BedroomsImg2 from "../../assets/Accomodations/Larger Groups/Bedrooms/Bedrooms Img 2.jpg";
...
function LargerGroups() {
  ...
  return (
    <>
      <div className="room-details">
        <div className="room-details-hero">
          <div className="room-details-hero-top">
            ...
            <h1>Private Entrance, Multiple Rooms, Common Hall, dining space</h1>
            <div className="room-details-hero-gallery">
              <div
                className="room-details-hero-gallery-img"
                style={{ gridArea: "box-1" }}
              >
                <img src={LivingRoomImg1} alt="Larger Groups Living Room" />
              </div>
              <div
                className="room-details-hero-gallery-img"
                style={{ gridArea: "box-2" }}
              >
                <img src={LivingRoomImg2} alt="Larger Groups Living Room" />
              </div>
              <div
                className="room-details-hero-gallery-img"
                style={{ gridArea: "box-3" }}
              >
                <img src={BathroomsImg1} alt="Larger Groups Bathrooms" />
              </div>
              <div
                className="room-details-hero-gallery-img"
                style={{ gridArea: "box-4" }}
              >
                <img src={BedroomsImg1} alt="Larger Groups Bedrooms" />
              </div>
              <div
                className="room-details-hero-gallery-img"
                style={{ gridArea: "box-5" }}
              >
                <img src={BedroomsImg2} alt="Larger Groups Bedrooms" />
                <Link
                  to="/accomodations/larger-groups/gallery"
      ...
      <Reach />
      <OtherRooms otherRoom="larger-groups"/>
      <CoorgGallery overlay={true} />
    </>
  );
}

export default LargerGroups;
