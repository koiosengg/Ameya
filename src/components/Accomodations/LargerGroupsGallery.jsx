...
import LivingRoomImg3 from "../../assets/Accomodations/Larger Groups/Living Room/Living Room Img 3.jpg";
...
import BedroomsImg3 from "../../assets/Accomodations/Larger Groups/Bedrooms/Bedrooms Img 3.jpg";
  ...
  return (
    <div className="room-details-gallery">
      ...
      <div className="gallery-space">
        <Spaceset
          title="Living Room"
          images={[LivingRoomImg1, LivingRoomImg2, LivingRoomImg3]}
        />
        <Spaceset
          title="Bedrooms"
          images={[BedroomsImg1, BedroomsImg2, BedroomsImg3]}
        />{" "}
        {/* <Spaceset
          title="Balcony"
          images={[
        ...
        /> */}
        <Spaceset title="Bathrooms" images={[BathroomsImg1]} />
      </div>
    </div>
  );
}

export default LargerGroupsGallery;
